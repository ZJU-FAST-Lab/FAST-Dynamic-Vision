...
EquidistantCamera::Parameters::Parameters(
const std::string& cameraName, int w, int h, double k2, double k3, double k4, double k5, double mu, double mv, double u0, double v0 )
...
void
EquidistantCamera::liftProjective( const Eigen::Vector2d& p, Eigen::Vector3d& P, float image_scale ) const
{
...
void
EquidistantCamera::spaceToPlane( const Eigen::Vector3d& P, Eigen::Vector2d& p, float image_scalse ) const
{
...
cv::Mat
EquidistantCamera::initUndistortRectifyMap(
...
void
EquidistantCamera::backprojectSymmetric( const Eigen::Vector2d& p_u, double& theta, double& phi ) const
{
    double tol      = 1e-10;
